...
docker run -e PYTHONUNBUFFERED=1 -v $(dirname $0)/../../data:/data --name "preprocess_sedona" --rm registry.gitlab.com/zergar/benchi/preprocess:0.2.7-1 python preprocess.py $1
