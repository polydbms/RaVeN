...
docker run -e PYTHONUNBUFFERED=1 -v $(dirname $0)/../../data:/data --name "preprocess_postgis" --rm registry.gitlab.com/zergar/benchi/preprocess:0.2.5-4 python preprocess.py $1
